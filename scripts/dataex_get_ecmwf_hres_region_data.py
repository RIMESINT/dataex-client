...
"""Get ecmwf hres region data CLI

This script allows the user to download analysis of ecmwf hres region data.

Usage:

$ dataex_get_ecmwf_hres_region_data.py --reducer <str> --asset_identifier <str> --unique_field <str> --output_format <str> --out <str>
...
from dataex_client_core.CONFIG import GET_ECMWF_HRES_REGION_DATA_URL
import requests
import click
