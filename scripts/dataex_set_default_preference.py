...
from dataexclient.config import SET_REGION_DEFAULT_URL, SET_POINT_DEFAULT_URL
...
@click.option('--preference_identifier', '-pi', required=True, help='unique identifier for preference', type=click.STRING)


def main(preference_type, preference_identifier):
    payload = dict()
    auth_obj = auth()
