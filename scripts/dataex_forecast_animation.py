...
@click.option('--hres_param', '-hp' ,required=False, help='Type one hres parameter name')
@click.option('--ens_param', '-ep' ,required=False,  help='Type one ens parameter name')
...
def main(model_type, hres_param, ens_param, latbounds, lonbounds, output):
